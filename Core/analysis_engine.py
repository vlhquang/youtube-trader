...
class AnalysisEngine:
    ...
    def discover_keywords(self, seed_keyword, region_code, mode, stop_event):
        params = {
    ...
    def full_analysis_for_keyword(self, keyword, region_code):
        ...
        logging.info(f'opportunity_score: {opportunity_score}')
    ...
    def _calculate_demand(self, keyword, region_code, timeframe_days, limit=50):
        logging.info(f'_calculate_demand keyword: {keyword}, region_code: {region_code}, timeframe_days: {timeframe_days}, limit: {limit}')
        params = {
